        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">System monitoring and analytics</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex space-x-8">
            ...
            <Link 
              ...
              className="py-4 px-2 border-b-2 border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 hover:border-gray-300"
            >
              User Management
            </Link>
            <Link 
