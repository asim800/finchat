...
class SystemConfig:
    ...
    def __post_init__(self):
        ...
        # Validate ticker file exists. Skip the warning for the unset default
        # placeholder, which is used by DEFAULT_SYSTEM_CONFIG / argparse defaults
        # and would otherwise fire noisily on every import.
        if self.ticker_file != '../tickers.txt' and not Path(self.ticker_file).exists():
