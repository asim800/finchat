...
Examples:
  ...
  python tests/test_mc_parameter_sweep.py --param initial_portfolio_value \\
    ...
    parser.add_argument('--config', type=str, default='configs/portfolio/test_simple_buyhold.json',
                        help='Config file path (default: configs/portfolio/test_simple_buyhold.json)')
